...
import com.company.polaris_bustrackingsystem.Models.AdminDash;
...
public class AdminHomepage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pbAdminDash = findViewById(R.id.pbAdminDash);
        ...
        list.add(new AdminDash("Manage Routes", R.drawable.route_icon_png));
        ...
        gvAdminDash.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(i == 2) {
                    pbAdminDash.setVisibility(View.VISIBLE);
                    startActivity(new Intent(AdminHomepage.this,ManageBus.class));
                    pbAdminDash.setVisibility(View.GONE);
                }
                if(i == 3) {
                    pbAdminDash.setVisibility(View.VISIBLE);
                    startActivity(new Intent(AdminHomepage.this,ManageRoutes.class));
                    pbAdminDash.setVisibility(View.GONE);
                }
            }
        });
    ...
    protected void onStart() {
        super.onStart();
        pbAdminDash.setVisibility(View.INVISIBLE);
